    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleVersions", x => new { x.ArticleID, x.VersionID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleVersions_Categories_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Categories",
                        principalColumn: "CategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Chapters", x => new { x.ChapterID, x.ArticleID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChapterVersions", x => new { x.ChapterID, x.ArticleID, x.VersionID });
                    table.ForeignKey(
                        name: "FK_ChapterVersions_ArticleVersions_ArticleID_VersionID",
                        columns: x => new { x.ArticleID, x.VersionID },
                        principalTable: "ArticleVersions",
                        principalColumns: new[] { "ArticleID", "VersionID" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleVersions_CategoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChapterVersions_ArticleID_VersionID",
                table: "ChapterVersions",
                columns: new[] { "ArticleID", "VersionID" });
